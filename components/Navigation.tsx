    ...
    <nav className="fixed w-full top-0 z-50 bg-arven-bg/95 border-b border-arven-magenta/20">
      <div className="container flex justify-between items-center py-4 px-4">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a
            href="#contact"
            className="px-6 py-2 bg-arven-magenta text-white font-medium hover:opacity-90 transition"
          >
            Get Pilot Audit
          </a>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="md:hidden text-arven-magenta"
          >
      ...
      {mobileOpen && (
        <div className="md:hidden bg-arven-darker border-t border-arven-magenta/20 py-4">
          <div className="container flex flex-col gap-4 px-4">
            <Link
              href="#how-it-works"
              className="text-arven-text hover:text-arven-magenta transition"
            ...
            <a
              href="#contact"
              className="px-6 py-2 bg-arven-magenta text-white font-medium hover:opacity-90 transition text-center"
              onClick={() => setMobileOpen(false)}
            >
              Get Pilot Audit
            </a>
